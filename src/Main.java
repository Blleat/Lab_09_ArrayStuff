...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\nThe number of times the value you entered found within the array is: " + count);
        ...
        if (position == -1) { //if index is -1 which it cant be
        ...
        System.out.print("\n\nThe maximum value within the array is: " + maximum);
        System.out.print("\n\nThe minimum value within the array is: " + minimum);
